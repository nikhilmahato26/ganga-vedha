import type { adventures, hotels, hotelRooms, siteSettings } from "@/db/schema";
...
export const ADVENTURES: AdventureInsert[] = [
  ...
  },
  {
    ...
    summary: "The full river. Five hours, every named rapid on the stretch, and a lunch stop on the sand.",
    description:
    ...
    whatToBring: WHAT_TO_BRING,
    faqs: baseFaqs(18),
    meetingPoint: "Ganga Vedha base, Tapovan. Early shuttle to Kaudiyala; report at 7:00 am.",
    minAge: 18,
    minWeightKg: 45,
    maxWeightKg: 110,
  ...
  },
  {
    ...
    summary: "Eighty-three metres off a cantilever platform over the Hyul valley. Three seconds of free fall.",
    description:
...
export const HOTELS: (HotelInsert & { rooms: Omit<typeof hotelRooms.$inferInsert, "hotelId">[] })[] = [
  {
